                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <a href="{{ route('pending.shipped', $item->id) }}" onclick="return confirm('Are You Sure?')" class="btn btn-sm btn-success"><i class="fa fa-paper-plane"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
